...
public:
	static constexpr auto INTERFACE_VERSION{ SHADER_UTIL_INTERFACE_VERSION };
public:
	...
	virtual bool ConvertImageFormat( unsigned char* src, ImageFormat srcImageFormat, unsigned char* dst, ImageFormat dstImageFormat, int width, int height, int srcStride = 0, int dstStride = 0 ) = 0;
